            ...
            <div class="card-body">
                <form onSubmit={handleSubmit}>
                    <div class="hstack">
                        ...
                        <div class="p-2 flex-grow-1 ms-auto">
                    ...
                    <button type="submit" class="position-absolute top-0 end-0 m-1 btn btn-sm btn-success" aria-label="Save note"><svg
                    ...
                    <button
                        type="reset"
                        class="position-absolute top-50 end-0 mx-1 btn btn-sm btn-outline-danger"
                        onClick={onCancel}
