    ...
    return (
        <div key={note.id} class="card border text-start">
            ...
            <div class="card-body">
                <button
                    type="button"
                    class="position-absolute top-0 end-0 m-1 btn btn-sm border-0 btn-outline-danger rounded-pill"
                ...
                <button
                    type="button"
                    class="position-absolute bottom-0 end-0 m-1 btn btn-sm border-0 btn-outline-primary rounded-pill"
                ...
                {/* <div class="hstack">
                    ...
                    <div class="p-2 ms-auto">
                        <button
                            class="btn border-0 btn-sm btn-outline-primary"
                            onClick={() => onEdit(note.id, note.content)}
                            aria-label="Edit note"
                            disabled={disableEdit}
                            aria-disabled={
