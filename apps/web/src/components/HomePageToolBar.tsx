import { addNote, sortByDescending, sortNotesInAscending, sortNotesInDescending } from "../store";
import { AddNote } from "./AddNote";

export function HomePageToolBar() {
    return (
        <div class="sticky-top container d-flex justify-content-center">
            <div role="toolbar"
                class="btn-toolbar row row-cols-auto justify-content-evenly g-1 align-items-center bg-body-secondary shadow-sm border-bottom border-5 rounded-3 mt-1 mb-2 p-2">
                <div class="col">
                    <div class="btn-group btn-group-sm" role="group" aria-label="Sorting button group">
                        <input type="radio" class="btn-check" name="btnradiosort" onClick={sortNotesInDescending} id="sortByDescending" autocomplete="off" checked={sortByDescending.value} />
                        <label class="btn btn-outline-primary" for="sortByDescending">
                        ...
                        <label class="btn btn-outline-primary" for="sortByAscending">
                            ...
                            <span class="visually-hidden">Sort in Ascending</span>
                        </label>
                    </div>
                </div>
                <div class="col">
